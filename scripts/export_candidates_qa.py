...
filtered = [row for row in rows if row.get("fit_tier") != "irrelevant"]
if not filtered:
    print("No experienced candidates after filtering out 'irrelevant' fit_tier.")
...
print(f"Wrote {OUT_PATH} with {len(filtered)} candidate rows.")
